          ...
          <li>
            <div class="slider-info banner-view">
              <div class="banner-info container">
                ...
                <p class="my-4 mb-5">PHP DEVELOPER</p><br>
    ...
    <div class="container pt-lg-3">
      ...
      <div class="aboutgrids row">
        <div class="col-lg-6 aboutgrid2">
          <img src="<?php echo $this->baseurl;?>/images/about.jpg" alt="about image" class="img-fluid" />
        </div>
        <div class="col-lg-6 aboutgrid1 my-lg-0 my-5">
          <h4>Why hire me for your next project?</h4>
          <p>I love to work in User Experience & User Interface designing. Because I love to solve the design problem and find easy and better
            solutions to solve it. I always try my best to make good user interface with the best user experience. I have been working as a Visual
            designer from.</p>
        ...
        <div class="row">
          ...
          <div class="col-lg-6 my-lg-0 my-5 align-self-center features-with-17-right_sur">
            <div class="features-with-17-right-tp_sur">
              ...
              <div class="features-with-17-left2">
                <h6><a href="#url">Responsiveness</a></h6>
            ...
            <div class="features-with-17-right-tp_sur">
              ...
              <div class="features-with-17-left2">
                <h6><a href="#url">Advanced Options</a></h6>
                <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Vero, dolore.</p>
              </div>
            </div>
            <div class="features-with-17-right-tp_sur">
      ...
      <div class="container py-lg-5">
        ...
        <div class="row no-gutters masonry">
          <div class="col-md-4 col-sm-6 brick">
            <a href="<?php echo $this->baseurl;?>/images/g1.jpg" class="js-img-viwer d-block" data-caption="There are many variations of popular graphic design"
              data-id="lion">
              <img src="<?php echo $this->baseurl;?>/images/g1.jpg" class="img-fluid insta-pic" alt="insta-pic" />
          ...
          <div class="col-md-4 col-sm-6 brick">
            <a href="<?php echo $this->baseurl;?>/images/g2.jpg" class="js-img-viwer d-block" data-caption="There are many variations of popular graphic design"
              data-id="camel">
              <img src="<?php echo $this->baseurl;?>/images/g2.jpg" class="img-fluid insta-pic" alt="insta-pic" />
              <div class="content-overlay"></div>
              <div class="content-details fadeIn-top">
                <h4>Work title here</h4>
                <p>Design</p>
          ...
          <div class="col-md-4 col-sm-6 brick">
            <a href="<?php echo $this->baseurl;?>/images/g3.jpg" class="js-img-viwer d-block" data-caption="There are many variations of popular graphic design"
              data-id="hippopotamus">
              <img src="<?php echo $this->baseurl;?>/images/g3.jpg" class="img-fluid insta-pic" alt="insta-pic" />
              <div class="content-overlay"></div>
              <div class="content-details fadeIn-top">
                <h4>Work title here</h4>
                <p>Design</p>
          ...
          <div class="col-md-4 col-sm-6 brick">
            <a href="<?php echo $this->baseurl;?>/images/g4.jpg" class="js-img-viwer d-block" data-caption="There are many variations of popular graphic design"
              data-id="koala">
              <img src="<?php echo $this->baseurl;?>/images/g4.jpg" class="img-fluid insta-pic" alt="insta-pic" />
              <div class="content-overlay"></div>
              <div class="content-details fadeIn-top">
                <h4>Work title here</h4>
                <p>Design</p>
          ...
          <div class="col-md-4 col-sm-6 brick">
            <a href="<?php echo $this->baseurl;?>/images/g5.jpg" class="js-img-viwer d-block" data-caption="There are many variations of popular graphic design"
              data-id="bear">
              <img src="<?php echo $this->baseurl;?>/images/g5.jpg" class="img-fluid insta-pic" alt="insta-pic" />
              <div class="content-overlay"></div>
              <div class="content-details fadeIn-top">
                <h4>Work title here</h4>
                <p>Design</p>
          ...
          <div class="col-md-4 col-sm-6 brick">
            <a href="<?php echo $this->baseurl;?>/images/g6.jpg" class="js-img-viwer d-block" data-caption="There are many variations of popular graphic design"
              data-id="rhinoceros">
              <img src="<?php echo $this->baseurl;?>/images/g6.jpg" class="img-fluid insta-pic" alt="insta-pic" />
              <div class="content-overlay"></div>
              <div class="content-details fadeIn-top">
                <h4>Work title here</h4>
                <p>Design</p>
          ...
          <div class="col-md-4 col-sm-6 brick">
            <a href="<?php echo $this->baseurl;?>/images/g7.jpg" class="js-img-viwer d-block" data-caption="There are many variations of popular graphic design"
              data-id="hippopotamus">
              <img src="<?php echo $this->baseurl;?>/images/g7.jpg" class="img-fluid insta-pic" alt="insta-pic" />
              <div class="content-overlay"></div>
              <div class="content-details fadeIn-top">
                <h4>Work title here</h4>
                <p>Design</p>
          ...
          <div class="col-md-4 col-sm-6 brick">
            <a href="<?php echo $this->baseurl;?>/images/g8.jpg" class="js-img-viwer d-block" data-caption="There are many variations of popular graphic design"
              data-id="koala">
              <img src="<?php echo $this->baseurl;?>/images/g8.jpg" class="img-fluid insta-pic" alt="insta-pic" />
              <div class="content-overlay"></div>
              <div class="content-details fadeIn-top">
                <h4>Work title here</h4>
                <p>Design</p>
          ...
          <div class="col-md-4 col-sm-6 brick">
            <a href="<?php echo $this->baseurl;?>/images/g9.jpg" class="js-img-viwer d-block" data-caption="There are many variations of popular graphic design"
              data-id="hippopotamus">
              <img src="<?php echo $this->baseurl;?>/images/g9.jpg" class="img-fluid insta-pic" alt="insta-pic" />
              <div class="content-overlay"></div>
              <div class="content-details fadeIn-top">
                <h4>Work title here</h4>
                <p>Design</p>
      ...
      <div class="container py-lg-3">
        ...
        <div class="customer row">
          <div class="col-lg-4 col-md-6 mt-md-3 mt-3">
            <div class="card">
              <img class="card-img-top img-responsive" src="<?php echo $this->baseurl;?>/images/c1.jpg" alt="">
          ...
          <div class="col-lg-4 col-md-6 mt-md-3 mt-5">
            <div class="card">
              <img class="card-img-top img-responsive" src="<?php echo $this->baseurl;?>/images/c2.jpg" alt="">
          ...
          <div class="col-lg-4 offset-md-3 offset-lg-0 col-md-6 mt-md-3 mt-5">
            <div class="card">
              <img class="card-img-top img-responsive" src="<?php echo $this->baseurl;?>/images/c3.jpg" alt="">
